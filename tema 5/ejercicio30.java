public class ejercicio30 {
  public static void main(String[] args) { 
    ...
    System.out.println("Los días válidos son: lunes, martes, miércoles, jueves y viern\
    es.");
    datosCorrectos = false;
    }
    if ((primeraHora < 0) || (primeraHora > 23) || (segundaHora < 0) || (segundaHora > 2\
    3)) {
    ...
    System.out.println(" hay " + (((segundoDia * 24) + segundaHora) - ((primerDia * 24) + \
    primeraHora)) + " horas.");
    }
    }
